...
The implementation below is merged into `main` (PR #27, September 7, 2026) and has been extended since. It is not in the published 0.3.0 packages, which predate it, or in the historical Sepolia deployments. Local acceptance evidence does not make it production software.
