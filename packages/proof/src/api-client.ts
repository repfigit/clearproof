...
export type ReportPath = '/pilot/policy/diff' | '/pilot/policy/diff/stored' | '/pilot/events/investigate' | '/pilot/events/queue' | '/pilot/proof/inspect' | '/pilot/proof/observe' | '/pilot/proof/observations/read' | '/pilot/proof/observations/report';
