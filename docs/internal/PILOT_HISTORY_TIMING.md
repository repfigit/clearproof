...
remains incomplete: retained information approvals and broader source compromise
handling still need independent historical validation before `supported` is safe.
