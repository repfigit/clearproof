...
The standalone [historical L2 cost model](scripts/l2_cost_model.py) includes an
op-geth FastLZ port under LGPL-3.0-or-later, with attribution in [NOTICE](NOTICE).
It is a development analysis tool, not part of the proof SDK or deployed verifier.
