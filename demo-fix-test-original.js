...
async function runDemoFix() {
  // Use the original test input that was failing
  const inputPath = path.resolve('./test-vector-fix/original-test-input.json');
  ...
  try {
    ...
    // --- Export ---
    const outDir = path.resolve('./demo-fix-output-original');
