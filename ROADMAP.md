...
| Production core | Not production-ready | Some auth modes and verification pieces exist, but durable state, tenant isolation, key delivery, audit durability, and verifier parity are not complete | Postgres/Redis-backed tenant-scoped pilot flow |
